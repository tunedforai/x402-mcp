...
server.tool("marketLight", "Any-token CoinGecko-backed market coverage via /data/light: price, momentum, rank, liquidity and exchange context, and risk flags. Defaults to brief=off for low latency; set brief=full for a Kimi brief. Supports listed CoinGecko symbols beyond the fixed Pillar token list, e.g. WCT.", {
